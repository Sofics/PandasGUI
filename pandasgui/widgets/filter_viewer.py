...
class FilterViewer(QtWidgets.QWidget):
    def __init__(self, pgdf: PandasGuiDataFrameStore):
        ...
        self.text_input_label = QtWidgets.QLabel(
            '''<a style="color: #1e81cc;" href="https://soficswiki.atlassian.net/wiki/spaces/SHAR/pages/1389494328/DataViewer#How-to-write-DataViewer-queries%3A">How to write these queries?</a>''')
